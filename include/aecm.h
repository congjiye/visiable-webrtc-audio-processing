//
// Created by aydon on 2021/3/18.
//

#ifndef AUDIO_PROCESSING_AECM_H
#define AUDIO_PROCESSING_AECM_H
#ifdef __cplusplus
extern "C" {
#endif
...
//
void WebRtc_AddBinaryFarSpectrum(BinaryDelayEstimatorFarend *self, uint32_t binary_far_spectrum);
...
int WebRtcAecm_ProcessBlock(AecmCore *aecm, const int16_t *farend, const int16_t *nearendNoisy,
                            const int16_t *noisyClean, int16_t *out);
...
//
void WebRtcAecm_BufferFarFrame(AecmCore *aecm, const int16_t *farend, int farLen);
...
//
void WebRtcAecm_FetchFarFrame(AecmCore *aecm, int16_t *farend, int farLen, int knownDelay);
...
//
void WebRtcAecm_CalcEnergies(AecmCore *aecm, const uint16_t *far_spectrum, int16_t far_q, uint32_t nearEner,
                             int32_t *echoEst);
...
//
void WebRtcAecm_UpdateChannel(AecmCore *aecm, const uint16_t *far_spectrum, int16_t far_q, const uint16_t *dfa,
                              int16_t mu, int32_t *echoEst);
...
// generic C code.
//
typedef void (*CalcLinearEnergies)(AecmCore *aecm, const uint16_t *far_spectrum, int32_t *echoEst, uint32_t *far_energy,
                                   uint32_t *echo_energy_adapt, uint32_t *echo_energy_stored);

extern CalcLinearEnergies WebRtcAecm_CalcLinearEnergies;

typedef void (*StoreAdaptiveChannel)(AecmCore *aecm, const uint16_t *far_spectrum, int32_t *echo_est);
...
void WebRtcAecm_CalcLinearEnergiesNeon(AecmCore *aecm, const uint16_t *far_spectrum, int32_t *echo_est,
                                       uint32_t *far_energy, uint32_t *echo_energy_adapt, uint32_t *echo_energy_stored);
...
void WebRtcAecm_CalcLinearEnergies_mips(AecmCore *aecm, const uint16_t *far_spectrum, int32_t *echo_est,
                                        uint32_t *far_energy, uint32_t *echo_energy_adapt,
                                        uint32_t *echo_energy_stored);
#if defined(MIPS_DSP_R1_LE)
void WebRtcAecm_StoreAdaptiveChannel_mips(AecmCore *aecm, const uint16_t *far_spectrum, int32_t *echo_est);
