...
#ifndef AUDIO_PROCESSING_VAD_H
#define AUDIO_PROCESSING_VAD_H
...
//                        0 - (Non-active Voice),
//                       -1 - (Error)
int WebRtcVad_Process(VadInst *handle, int fs, const int16_t *audio_frame, size_t frame_length, int keep_weight);

#ifdef __cplusplus
}
#endif
#endif //AUDIO_PROCESSING_VAD_H
