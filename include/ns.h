...
#ifndef AUDIO_PROCESSING_NS_H
#define AUDIO_PROCESSING_NS_H
 ...
 */
void WebRtcNs_ProcessCore(NoiseSuppressionC *self, const int16_t *const *inFrame, size_t num_bands,
